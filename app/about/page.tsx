  ...
  return (
    <SiteShell>
      <section className="relative h-[42vh] min-h-[280px] overflow-hidden">
        <img src={IMAGES.building} alt="Neha Hospitals building" className="absolute inset-0 h-full w-full object-cover img-slow-pan" />
        <div className="absolute inset-0 bg-navy/70" />
        <div className="container-site relative flex h-full items-end pb-10">
          <div className="text-white">
            <h1 className="animate-fade-up font-serif text-4xl sm:text-5xl">{t.about.title}</h1>
            <p className="animate-fade-up mt-3 max-w-2xl text-white/85" style={{ animationDelay: "150ms" }}>{t.about.lead}</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <ScrollReveal className="container-site grid gap-12 lg:grid-cols-2">
          ...
          <div className="overflow-hidden">
            <img src={IMAGES.reception} alt="Hospital reception" className="h-[360px] w-full object-cover transition-transform duration-500 ease-out hover:scale-[1.02]" />
          </div>
        </ScrollReveal>
      </section>

      <section className="border-y border-line bg-paper py-16">
        <ScrollReveal className="container-site grid gap-12 md:grid-cols-2">
          <div>
      ...
      <section className="py-16">
        <div className="container-site">
          ...
          <div className="mt-10 grid gap-10 md:grid-cols-2">
            <ScrollReveal delay={100}><Value t={t.about.v1t} p={t.about.v1} /></ScrollReveal>
            <ScrollReveal delay={200}><Value t={t.about.v2t} p={t.about.v2} /></ScrollReveal>
            <ScrollReveal delay={300}><Value t={t.about.v3t} p={t.about.v3} /></ScrollReveal>
            <ScrollReveal delay={400}><Value t={t.about.v4t} p={t.about.v4} /></ScrollReveal>
          </div>
        </div>
      </section>

      <section className="bg-paper py-16">
        <ScrollReveal className="container-site grid items-center gap-10 lg:grid-cols-2">
          <div className="overflow-hidden">
            <img src={IMAGES.rooms} alt="Inpatient rooms" className="h-[380px] w-full object-cover transition-transform duration-500 ease-out hover:scale-[1.02]" />
          </div>
          <div>
      ...
      <section className="py-16">
        <ScrollReveal className="container-site grid items-center gap-10 lg:grid-cols-2">
          ...
          <div className="overflow-hidden">
            <img src={IMAGES.lab} alt="Diagnostic laboratory" className="h-[380px] w-full object-cover transition-transform duration-500 ease-out hover:scale-[1.02]" />
          </div>
        </ScrollReveal>
      </section>
      ...
      <section className="py-16">
        <ScrollReveal className="container-site grid items-center gap-10 lg:grid-cols-2">
          <div className="overflow-hidden">
            <img src={IMAGES.leadership} alt="Senior consultant" className="h-[380px] w-full object-cover transition-transform duration-500 ease-out hover:scale-[1.02]" />
          </div>
          <div>
      ...
      <section className="py-16">
        <ScrollReveal className="container-site">
          ...
          <ul className="mt-8 max-w-2xl space-y-3 text-[15px] text-muted">
            <li className="transition-transform duration-200 hover:translate-x-1">— {t.about.t1}</li>
            <li className="transition-transform duration-200 hover:translate-x-1">— {t.about.t2}</li>
            <li className="transition-transform duration-200 hover:translate-x-1">— {t.about.t3}</li>
            <li className="transition-transform duration-200 hover:translate-x-1">— {t.about.t4}</li>
          </ul>
